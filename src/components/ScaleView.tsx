...
const scaleData = [
  {
    ...
    vercel: 20, vps: 48, supabase: 25, aiCompute: 14, monitoring: 0, stripe: 14, sendgrid: 0, weather: 0, loki: 0, ghActions: 0,
    ...
    get totalCost() { return this.infraCost + this.aiCompute + this.stripe; },
    setupFees: 1 * BLENDED_SETUP,
  },
  {
    customers: 10,
    monthlyRevenue: 10 * MONTHLY_PER_CUSTOMER,
    vercel: 20, vps: 96, supabase: 25, aiCompute: 140, monitoring: 0, stripe: 136, sendgrid: 0, weather: 0, loki: 0, ghActions: 0,
    get infraCost() { return this.vercel + this.vps + this.supabase + this.monitoring + this.sendgrid + this.weather + this.loki + this.ghActions; },
    get totalCost() { return this.infraCost + this.aiCompute + this.stripe; },
  ...
  },
  {
    ...
    vercel: 20, vps: 96, supabase: 25, aiCompute: 700, monitoring: 0, stripe: 682, sendgrid: 20, weather: 40, loki: 0, ghActions: 0,
    get infraCost() { return this.vercel + this.vps + this.supabase + this.monitoring + this.sendgrid + this.weather + this.loki + this.ghActions; },
    get totalCost() { return this.infraCost + this.aiCompute + this.stripe; },
  ...
  },
  {
    ...
    vercel: 20, vps: 192, supabase: 25, aiCompute: 1400, monitoring: 0, stripe: 1364, sendgrid: 20, weather: 40, loki: 0, ghActions: 50,
    get infraCost() { return this.vercel + this.vps + this.supabase + this.monitoring + this.sendgrid + this.weather + this.loki + this.ghActions; },
    get totalCost() { return this.infraCost + this.aiCompute + this.stripe; },
  ...
  },
  {
    ...
    vercel: 150, vps: 1500, supabase: 599, aiCompute: 14000, monitoring: 50, stripe: 13640, sendgrid: 90, weather: 40, loki: 75, ghActions: 100,
    get infraCost() { return this.vercel + this.vps + this.supabase + this.monitoring + this.sendgrid + this.weather + this.loki + this.ghActions; },
    get totalCost() { return this.infraCost + this.aiCompute + this.stripe; },
