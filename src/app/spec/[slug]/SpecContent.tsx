    ...
    <div className="spec-content">
      <ReactMarkdown
        ...
        components={{
          ...
          h5: (props) => <h5 className="text-base font-medium text-slate-300 mt-4 mb-2" {...props} />,
          ...
          code: ({ children, className, ...props }) => {
            ...
            return (
              <code className="bg-white/5 border border-white/10 rounded px-1.5 py-0.5 text-sm text-indigo-300 font-mono" {...props}>
                {children}
              </code>
            );
          },
